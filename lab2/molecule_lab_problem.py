...
def atoms_connected(state):
    ...
    if H1_j == O_j and H1_i == (O_i - 1):
        if H2_j == O_j and H2_i == (O_i + 1):
            return True
    return False
...
if __name__ == "__main__":
    H1AtomRedica = int(input()) - 1  # for zero-based matrix
    H1AtomKolona = int(input()) - 1  # for zero-based matrix
    OAtomRedica = int(input()) - 1  # for zero-based matrix
    OAtomKolona = int(input()) - 1  # for zero-based matrix
    H2AtomRedica = int(input()) - 1  # for zero-based matrix
    H2AtomKolona = int(input()) - 1  # for zero-based matrix
