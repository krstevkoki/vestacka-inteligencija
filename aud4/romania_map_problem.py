...
if __name__ == "__main__":
    romania_map = UndirectedGraph(dict(
        ...
        Zerind=dict(Oradea=71),
        Oradea=dict(Sibiu=151),
        Timisoara=dict(Lugoj=111),
        Lugoj=dict(Mehadia=70),
        Mehadia=dict(Drobeta=75),
        Drobeta=dict(Craiova=120),
        Sibiu=dict(Fagaras=99, Rimnicu=80),
        Craiova=dict(Rimnicu=146, Pitesti=138),
        Rimnicu=dict(Pitesti=97),
        Fagaras=dict(Bucharest=211),
        Pitesti=dict(Bucharest=101),
        Bucharest=dict(Giurgiu=90, Urziceni=85),
        Urziceni=dict(Vaslui=142, Hirsova=86),
        Vaslui=dict(Iasi=92),
        Iasi=dict(Neamt=87),
        Hirsova=dict(Eforie=86)
    ))
