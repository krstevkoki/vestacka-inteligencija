...
if __name__ == "__main__":
    ...
    graph_map = UndirectedGraph(dict(
        A=dict(B=distance(graph_map.locations['A'], graph_map.locations['B'])),
        B=dict(C=distance(graph_map.locations['B'], graph_map.locations['C']),
               I=(distance(graph_map.locations['B'], graph_map.locations['I']))),
        C=dict(D=distance(graph_map.locations['C'], graph_map.locations['D']),
               G=distance(graph_map.locations['C'], graph_map.locations['G']),
               F=distance(graph_map.locations['C'], graph_map.locations['F'])),
        D=dict(E=distance(graph_map.locations['D'], graph_map.locations['E']),
               L=distance(graph_map.locations['D'], graph_map.locations['L'])),
        F=dict(J=distance(graph_map.locations['F'], graph_map.locations['J']),
               G=distance(graph_map.locations['F'], graph_map.locations['G'])),
        G=dict(K=distance(graph_map.locations['G'], graph_map.locations['K'])),
        H=dict(I=distance(graph_map.locations['H'], graph_map.locations['I'])),
        I=dict(J=distance(graph_map.locations['I'], graph_map.locations['J'])),
        K=dict(L=distance(graph_map.locations['K'], graph_map.locations['L'])),
        L=dict(M=distance(graph_map.locations['L'], graph_map.locations['M']))
    ))
    ...
    problem = GraphProblem(Pocetok, Kraj, graph_map)
