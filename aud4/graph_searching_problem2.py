...
if __name__ == "__main__":
    ...
    ABDistance = distance(graph_map.locations['A'], graph_map.locations['B'])
    BCDistance = distance(graph_map.locations['B'], graph_map.locations['C'])
    BIDistance = distance(graph_map.locations['B'], graph_map.locations['I'])
    CDDistance = distance(graph_map.locations['C'], graph_map.locations['D'])
    CGDistance = distance(graph_map.locations['C'], graph_map.locations['G'])
    CFDistance = distance(graph_map.locations['C'], graph_map.locations['F'])
    DEDistance = distance(graph_map.locations['D'], graph_map.locations['E'])
    DLDistance = distance(graph_map.locations['D'], graph_map.locations['L'])
    FJDistance = distance(graph_map.locations['F'], graph_map.locations['J'])
    FGDistance = distance(graph_map.locations['F'], graph_map.locations['G'])
    GKDistance = distance(graph_map.locations['G'], graph_map.locations['K'])
    HIDistance = distance(graph_map.locations['H'], graph_map.locations['I'])
    IJDistance = distance(graph_map.locations['I'], graph_map.locations['J'])
    KLDistance = distance(graph_map.locations['K'], graph_map.locations['L'])
    LMDistance = distance(graph_map.locations['L'], graph_map.locations['M'])

    graph_map = UndirectedGraph(dict(
        A=dict(B=ABDistance),
        B=dict(C=BCDistance, I=BIDistance),
        C=dict(D=CDDistance, G=CGDistance, F=CFDistance),
        D=dict(E=DEDistance, L=DLDistance),
        F=dict(J=FJDistance, G=FGDistance),
        G=dict(K=GKDistance),
        H=dict(I=HIDistance),
        I=dict(J=IJDistance),
        K=dict(L=KLDistance),
    ...
    answer1 = astar_search(problem1).solve()
    answer2 = astar_search(problem2).solve()
    answer = answer1 + answer2[1:]
