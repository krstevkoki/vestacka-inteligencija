...
# Funkcija koja presmetuva Menheten rastojanie za slozuvalkata. Na vlez dobiva dva celi broja koi odgovaraat na dve
# polinja na koi se naogaat broevite za koi treba da presmetame rastojanie
def mhd(n, m):
    x1, y1 = coordinates[n]
    x2, y2 = coordinates[m]
